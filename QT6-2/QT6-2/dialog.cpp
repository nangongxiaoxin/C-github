    ...
    : QDialog(parent)
{
    ...
    QPushButton *button1=new QPushButton(iconf1,"歪比巴伯",widget);
    QIcon iconf2(":/img/2.ico");
    QPushButton *button2=new QPushButton(iconf2,"娃娃肉",widget);
    widget->setGeometry(30,0,40,80);
    button1->setGeometry(35,5,120,60);
    button2->setGeometry(35,70,120,60);
    toolBox->addItem(widget,"are you good 马来西亚");
    ...
    toolBox->addItem(buttonStrange,"歪比歪比");
